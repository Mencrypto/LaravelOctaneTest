...
<head>
    ...
    <title>Test de foro de programación</title>
    ...
    <div class="h-screen flex flex-col">
        ...
        <div class="relative h-full flex items-center justify-center">
            <div class="absolute inset-x-0 -top-40 -z-10 transform-gpu blur-3xl sm:-top-80">
                <div class="relative left-[calc(50%-11rem)] aspect-1155/678 w-144.5 -translate-x-1/2 rotate-30 bg-linear-to-tr from-[#ff80b5] to-[#ff8000] opacity-80 sm:left-[calc(80%-30rem)] sm:w-288.75" style="clip-path: polygon(74.1% 44.1%, 100% 61.6%, 97.5% 26.9%, 85.5% 0.1%, 80.7% 2%, 72.5% 32.5%, 60.2% 62.4%, 52.4% 68.1%, 47.5% 58.3%, 45.2% 34.5%, 27.5% 76.7%, 0.1% 64.9%, 17.9% 100%, 27.6% 76.8%, 76.1% 97.7%, 74.1% 24.1%)"></div>
            </div>
            ...
            <div class="max-w-2xl">
                ...
                <div class="text-center">
                    <h1 class="text-5xl font-semibold text-gray-900 sm:text-7xl">Bienvenido al foro </h1>                        
